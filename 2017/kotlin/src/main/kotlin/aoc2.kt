...
val spreadsheet = """278 1689    250 1512    1792    1974    175 1639    235 1635    1690    1947    810 224 928 859
    ...
    return blk
            ...
            .map {
                it
                        ...
                        .map { it.toInt() }
                        .fold(Pair(Int.MAX_VALUE, 0), { p, current -> Pair(Math.min(p.first, current), Math.max(p.second, current)) })
            }
            .map {
                it.second - it.first
            }
